...
The Kiln desktop app is a free download, available on [MacOS and Windows](https://github.com/Kiln-AI/Kiln/releases/latest). We have experimental [Linux support](https://github.com/Kiln-AI/Kiln/actions/workflows/build_desktop.yml).
